...
const About = () => {
    const skills = {
        ...
        "DBMS": "Oracle, PostgreSQL, MySQL, InfluxDB, MongoDB",
            ...
            <div className="flex flex-col md:flex-row items-center md:w-full">
                ...
                <div className="md:w-2/3 text-center md:text-left flex flex-col">
                    ...
                    <p className="mt-4 text-gray-700 dark:text-gray-300">
                        Full-Stack Developer specializing in Java, React and Angular with over 3+ years of experience in building and
